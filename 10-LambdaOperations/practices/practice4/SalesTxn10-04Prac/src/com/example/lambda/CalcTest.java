...
public class CalcTest {
    ...
    public static void main(String[] args) {
       ...
       System.out.println("=== Transactions Totals ===");
        ...
        .filter(t->t.getBuyerName().equals("Radio Hut")).mapToDouble(t->t.getTransactionTotal()).sum();
        
        System.out.printf("Radio Hut Total: $%,9.2f%n", t1);
        
        // Replace with Stream
        double t2 = tList.stream()
        .filter(t->t.getBuyerName().equals("PriceCo")).mapToDouble(t->t.getTransactionTotal()).sum();
        
        System.out.printf("PriceCo Total: $%,9.2f%n", t2);
        // Replace with stream
        double t3 = tList.stream()
        .filter(t->t.getBuyerName().equals("Best Deals")).mapToDouble(t->t.getTransactionTotal()).sum();;
        ...
        OptionalDouble a1 = OptionalDouble.of(tList.stream()
                 .filter(t -> t.getProduct().equals("Widget Pro"))
                 .mapToDouble(t->t.getUnitCount()).average().getAsDouble());
        ...
        // Replace with stream
        OptionalDouble a2 = OptionalDouble.of(tList.stream()
